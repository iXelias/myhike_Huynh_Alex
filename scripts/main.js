    ...
    db.collection(collection)
        ...
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                var docID = doc.id; //grabs the ID for the hike
                ...
                newcard.querySelector('a').href = "eachHike.html?docID="+docID; //READMORE BUTTON
                newcard.querySelector('.card-length').innerHTML =
                    "Length: " + doc.data().length + " km <br>" +
                    "Duration: " + doc.data().hike_time + "min <br>" +
                    "Last updated: " + doc.data().last_updated.toDate().toLocaleDateString();

                //Assigns unique id to bookmark line
                //Attaching onclick function to save bookmark
...
displayCardsDynamically("hikes");  //input param is the name of the collections
